...
@section('content')
    ...
    <section class="booking-container">
        <nav class="tab-nav">
            ...
            <a href="/menunggu-pembayaran" class="active">Menunggu Pembayaran</a>
        ...
        <div class="tab-content">
                ...
                <div class="booking-actions">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; width: 100%;">
                        @if($booking->status == 'menunggu_pembayaran')
                            <span class="status-tag pending" style="background-color: #fff3cd; color: #856404;">
                                <i class="fas fa-wallet" style="margin-right: 5px;"></i> Silakan Lakukan Pembayaran
                            </span>
                        @elseif($booking->status == 'verifikasi_pembayaran')
                            <span class="status-tag pending" style="background-color: #d1e7dd; color: #0f5132;">
                                <i class="fas fa-search-dollar" style="margin-right: 5px;"></i> Menunggu Verifikasi Pembayaran
                            </span>
                        @endif
                    </div>
                    ...
                    <div class="action-buttons">
                        @if($booking->status == 'menunggu_pembayaran')
                            <a href="/pembayaran-sewa/{{ $booking->id }}" class="btn btn-pay">
                                <i class="fas fa-money-bill-wave"></i> Bayar Sekarang
                            </a>
                        @endif
                        
                        @if($booking->status != 'verifikasi_pembayaran')
            ...
            <div class="empty-state" style="text-align: center; color: #6c757d; padding: 40px;">
                ...
                <p>Tidak ada booking yang menunggu pembayaran</p>
            </div>
            @endforelse
        </div>
    </section>
